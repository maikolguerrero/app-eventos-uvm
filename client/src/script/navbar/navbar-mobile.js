...
btn.addEventListener('click', () => {//añadimos listener que cambie al hacer click
...
const btnUserDesk = document.querySelector('.header__user-img-desk-btn')//para el login al hacer click en el icono de user

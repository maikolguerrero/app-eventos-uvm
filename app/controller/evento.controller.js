...
async function getInicializarionData (req, res) {
    try {
        ...
        res.status(200).json({eventos : res_eventos, message: 'Inicialización Exitosa'})
    } catch (error) {
        console.error(error);
        res.status(500).json({error: 'Ocurrió un error al obtener los datos de inicialización'});
    }
}
...
async function getEventoEdad (req, res) {
    try {
        ...
        console.error(error);
        res.status(500).json({error: 'Ocurrió un error al obtener los eventos por edad'});
    }
}
...
async function getEventoTitulo (req, res) {
    try {
        ...
        console.error(error);
        res.status(500).json({error: 'Ocurrió un error al obtener los eventos por título'});
    }
}
...
async function getEventoLugar (req, res) {
    try {
        ...
        console.error(error);
        res.status(500).json({error: 'Ocurrió un error al obtener los eventos por lugar'});
    }
}
...
async function getEventoOrganizador (req, res) {
    try {
        ...
        console.error(error);
        res.status(500).json({error: 'Ocurrió un error al obtener los eventos por organizador'});
    }
}
...
async function getEventoValoracion (req, res) {
    try {
        ...
        console.error(error);
        res.status(500).json({error: 'Ocurrió un error al obtener los eventos por valoración'});
    }
}
...
async function getEventoDuracion (req, res) {
    try {
        ...
        console.error(error);
        res.status(500).json({error: 'Ocurrió un error al obtener los eventos por duración'});
    }
}
...
async function getEventoFecha (req, res) {
    try {
        ...
        console.error(error);
        res.status(500).json({error: 'Ocurrió un error al obtener los eventos por fecha'});
    }
}
...
async function newEvento (req, res) {
    try {
        ...
        console.error(error);
        res.status(500).json({error: 'Ocurrió un error al crear un nuevo evento'});
    }
}
